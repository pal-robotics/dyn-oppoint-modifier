...
public:  /* --- SIGNALS --- */
//    dynamicgraph::Vector& setTransformationSig(dynamicgraph::Vector& res, int time );
    ...
    DECLARE_SIGNAL_IN(transformationSig,dynamicgraph::Vector);

private:

    sot::MatrixHomogeneous convertToHomo(const dynamicgraph::Vector& translation) const ;
